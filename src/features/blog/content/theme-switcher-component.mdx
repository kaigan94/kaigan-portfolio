...
description: "A simple and standalone theme switcher for Next.js using next-themes and Tailwind CSS."
image: "/images/theme-switcher.webp"
category: components
...
```bash
npx shadcn@latest add @kaigan94/theme-switcher
```
